...
> \KuntaAPI\Model\NewsArticle[] listOrganizationNews($organizationId, $slug, $tag, $publishedBefore, $publishedAfter, $search, $firstResult, $maxResults)
...
try {
    $result = $api_instance->listOrganizationNews($organizationId, $slug, $tag, $publishedBefore, $publishedAfter, $search, $firstResult, $maxResults);
    print_r($result);
} catch (Exception $e) {
