...
# **findService**
> \KuntaAPI\Model\Service findService($organizationId, $serviceId, $onlySource)
...
$organizationId = "organizationId_example"; // string | Organization id
$serviceId = "serviceId_example"; // string | Service id
$onlySource = true; // bool | whether return enriched content or just the source data

try {
    $result = $api_instance->findService($organizationId, $serviceId, $onlySource);
    print_r($result);
} catch (Exception $e) {
 ...
 **organizationId** | **string**| Organization id |
 **serviceId** | **string**| Service id |
 **onlySource** | **bool**| whether return enriched content or just the source data | [optional]
