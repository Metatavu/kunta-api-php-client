...
> \KuntaAPI\Model\Page[] listOrganizationPages($organizationId, $parentId, $path, $search, $sortOrder, $sortDir, $firstResult, $maxResults)
...
try {
    $result = $api_instance->listOrganizationPages($organizationId, $parentId, $path, $search, $sortOrder, $sortDir, $firstResult, $maxResults);
    print_r($result);
} catch (Exception $e) {
