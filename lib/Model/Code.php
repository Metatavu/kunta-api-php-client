 ...
 *
 * @category    Class */
 // @description Generic code item describing code / name pair (e.g. LanguageCode, MunicipalityCode, etc...)
/** 
 * @package     KuntaAPI
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
...
class Code implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'extra' => '\KuntaAPI\Model\CodeExtra[]'
    );
    ...
    /**
     * Sets type
     * @param string $type Type of the code. Value must be one of MUNICIPALITY, PROVINCE, HOSPITALREGIONS, BUSINESSREGIONS, COUNTRY, LANGUAGE, POSTAL
     * @return $this
     */
    ...
    /**
     * Sets names
     * @param \KuntaAPI\Model\LocalizedValue[] $names Names
     * @return $this
     */
    ...
    /**
     * Gets extra
     * @return \KuntaAPI\Model\CodeExtra[]
     */
    ...
    /**
     * Sets extra
     * @param \KuntaAPI\Model\CodeExtra[] $extra Names
     * @return $this
     */
