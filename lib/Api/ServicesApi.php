...
class ServicesApi
{
     ...
     * @throws \KuntaAPI\ApiException on non-2xx response
     */
    public function listServices($organizationId = null, $search = null, $sortOrder = null, $sortDir = null, $firstResult = null, $maxResults = null)
    {
        list($response) = $this->listServicesWithHttpInfo($organizationId, $search, $sortOrder, $sortDir, $firstResult, $maxResults);
        return $response;
    }
     ...
     * @throws \KuntaAPI\ApiException on non-2xx response
     */
    public function listServicesWithHttpInfo($organizationId = null, $search = null, $sortOrder = null, $sortDir = null, $firstResult = null, $maxResults = null)
    {
        // parse inputs
        $resourcePath = "/services";
        $httpBody = '';
