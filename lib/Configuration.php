...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://demo.kuntaapi.fi/v1';
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/0.0.1-alpha1/php";
    ...
    {
        $report  = 'PHP SDK (KuntaAPI) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 0.0.1' . PHP_EOL;
        $report .= '    SDK Package Version: 0.0.1-alpha1' . PHP_EOL;
